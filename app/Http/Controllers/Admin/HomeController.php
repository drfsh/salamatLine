...
class HomeController extends Controller{
	...
	protected function mvp($data){
		return $data->filter(function($item){return starts_with($item['url'], '/products/');});
	}
	protected function mvc($data){
		return $data->filter(function($item){return starts_with($item['url'], '/category/');});
	}
	protected function mvb($data){
		return $data->filter(function($item){return starts_with($item['url'], '/brands/');});
	}
