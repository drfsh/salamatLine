...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        View::composer('*', function($view)
        {
            ...
            ->with('globalcontact', Cache::remember('globalcontact', 864000, function () {return app('App\Models\Contactinfo')->select('id','phone1','phone2','address','email','mapurl')->where('id', 1)->get();}))
