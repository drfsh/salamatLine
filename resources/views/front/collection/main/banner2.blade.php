<div class="bg-banner @if($data['page']['banners'][2]->style->container)grid-container @endif"
     style="background: {{$data['page']['banners'][2]->style->mainBackground}}">
    <div class="grid-x grid-padding-x ">

        @foreach($data['page']['banners'][2]->items as $item)
            @if($item->type=='banner')
